...
This repository contains a reproducible way of implementing End-to-End ML Workflow using mlflow and W&B . The environments is being maintained by conda and configuration is being managed by Hydra. This reproducible workflow will follow the below steps.
  1. Download the Data
  2. Data clean up and Initial checks
  3. Data Split into train & validation and test Datasets
  4. Training the ML Algorithim
  5. Validation against Dataset

All artifacts thta are generated by components are being uploaded into W&B.
...
![W&B Lineage Graph](images/Linage.png)


Below are the detail tool set to produce ML Work-flow

1. [MLflow] (https://mlflow.org/releases/2.8.1) for reproducing the re-usable ML Work flow
2. [Hydra] (https://hydra.cc/docs/intro/) for coniguration and parameters Management
1. [Conda] (https://docs.conda.io/en/latest/) for environment management (Docker is another option)
1. [Weights & Biases] (https://wandb.ai/)  for Artifact tracking and Management
1. [Pandas and Scikit-Learn] (https://scikit-learn.org/stable/ &  https://pandas.pydata.org/)
